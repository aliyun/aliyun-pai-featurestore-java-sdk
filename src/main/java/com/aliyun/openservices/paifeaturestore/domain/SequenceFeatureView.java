...
public class SequenceFeatureView implements IFeatureView {
    ...
    public FeatureResult getOnlineFeatures(String[] joinIds, String[] features, Map<String, String> aliasFields) throws Exception {
        if (this.config.getRegistrationMode().equals(ConstantValue.Seq_Registration_Mode_Only_Behavior)) {
            throw new RuntimeException("Only Full Sequence Feature View can be used in getOnlineFeatures");
        }
