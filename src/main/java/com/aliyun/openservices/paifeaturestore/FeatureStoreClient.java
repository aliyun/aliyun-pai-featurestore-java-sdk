...
public class FeatureStoreClient {
    ...
    private void loadProjectData() throws Exception {
        ...
        for( com.aliyun.openservices.paifeaturestore.model.Project project : listProjectResponse.getProjects()) {
            ...
            Project domainProject = new Project(project);
            ...
            do{
                ...
                for (FeatureView view: listFeatureViewsResponse.getFeatureViews()) {
                    ...
                    com.aliyun.openservices.paifeaturestore.domain.FeatureView domainFeatureView = new com.aliyun.openservices.paifeaturestore.domain.FeatureView(featureView, domainProject,
                            domainProject.getFeatureEntityMap().get(featureView.getFeatureEntityName()) );
